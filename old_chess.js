let gameId = document.querySelector("#gameId").innerText.trim();
console.log("Game id:"+gameId);

let playerId = document.querySelector("#playerId").innerText.trim();
...
function updateTurn(){
    ...
    fetch("update_box.php",{
        method: "POST",
        headers: { "Content-Type": "application/x-www-form-urlencoded" },
        body: "game_id="+gameId+"&player="+playerId+"&isGameOver="+(!isGameContinue)+"&result="+result+"&chessBoxHTML="+encodeURIComponent(chessBoxHTML)
...
function retriveUpdatedBox(){
        ...
        fetch("update_box.php?game_id="+gameId)
            .then(response => response.json())
            .then(data => {
                console.log(data);
                
                if(data.player != null && data.player != playerId){
                    console.log(data.player);
                        chessBox.innerHTML = data.chessBoxHTML;

                        // chess : innerbox can change :
                    ...
                    if(data.error_wrong != null){
                        console.log(data.error_wrong);
                        window.open("die.php");
                        this.close();
                    }else{
